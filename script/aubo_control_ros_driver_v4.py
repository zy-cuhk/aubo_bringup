...
class AuboRosDriver():
    def __init__(self):
        ...
        self.aubo_joint_pub = rospy.Publisher('aubo_joints', JointState, queue_size=1)
        self.aubo_pose_pub = rospy.Publisher('aubo_pose', Pose, queue_size=1)
        self.aubo_vel_pub = rospy.Publisher('aubo_vel', catersian_vel,queue_size=1)
    ...
    def obtain_aubo_info(self):
        ...
        if self.count==1:
            catersian_velocity.v=0
            catersian_velocity.vx=0
            catersian_velocity.vy=0
            catersian_velocity.vz=0
