...
class AuboRosDriver():
    ...
    def obtain_aubo_info(self):
        ...
        # print("joint current",joint_status['joint1']['current']*0.001)
        # print("joint voltage",joint_status['joint1']['voltage'])
        # print("joint temperature",joint_status['joint1']['temperature'])
        #joint_status_msg.current[0]=joint_status['joint1']['current'] #np.array([])
        ...
        # print("joint status",joint_status_msg.current[0])
